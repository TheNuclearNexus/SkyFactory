...
execute if entity @e[tag=sf.stopRay,distance=..3,limit=1,sort=nearest] run data modify entity ArmorItems[2] set from entity @s ArmorItems[2]
...
execute if entity @e[tag=sf.stopRay,distance=..3,limit=1,sort=nearest] run kill @s
