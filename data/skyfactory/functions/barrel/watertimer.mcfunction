...
execute as @s[nbt={ArmorItems:[{id:"minecraft:poppy",Count:1b,tag:{CustomModelData:431}}]}] at @s if block ~ ~1 ~ #skyfactory:sand run function skyfactory:barrel/setclay
